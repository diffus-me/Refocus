...
from ldm_patched.modules.model_management import interrupt_current_processing
...
class pipeline:
    ...
    def merge_models(self, name):
        ...
        model_info = get_all_model_info().get_model(name)
    ...
    def process(
        ...
        if progressbar:
            progressbar(1, "Processing text encoding ...")
